...
Seize__new <- function(resource, amount, cont, willqueue, trj, mask) {
    .Call(`_simmer_Seize__new`, resource, amount, cont, willqueue, trj, mask)
}

Seize__new_func <- function(resource, amount, cont, willqueue, trj, mask) {
    .Call(`_simmer_Seize__new_func`, resource, amount, cont, willqueue, trj, mask)
}

SeizeSelected__new <- function(id, amount, cont, willqueue, trj, mask) {
    .Call(`_simmer_SeizeSelected__new`, id, amount, cont, willqueue, trj, mask)
}

SeizeSelected__new_func <- function(id, amount, cont, willqueue, trj, mask) {
    .Call(`_simmer_SeizeSelected__new_func`, id, amount, cont, willqueue, trj, mask)
}
