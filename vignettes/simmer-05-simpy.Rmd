...
These examples are adapted from the Python package 'SimPy', [here](https://simpy.readthedocs.io/en/latest/examples). Users familiar with SimPy may find these examples helpful for transitioning to `simmer`. Some very basic material is not covered. Beginners should first read the vignettes [_Introduction to simmer_](simmer-01-introduction.html), [_Terminology_](simmer-02-terminology.html), [_Advanced Trajectory Usage_](simmer-03-trajectories.html) and _[The Bank Tutorial: Part I](simmer-04-bank-1.html) & [Part II](simmer-04-bank-2.html)_.
