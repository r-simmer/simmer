...
[_Introduction to simmer_](simmer-01-introduction.html),
[_Terminology_](simmer-02-terminology.html), [_Advanced Trajectory
Usage_](simmer-03-trajectories.html) and [_The Bank Tutorial: Part I_](simmer-04-bank-1.html).
...
customer <-
  ...
  trap("phonecall",
       handler = trajectory() %>%
         ...
         set_attribute(
           "timeleft", function() {
             get_attribute(bank, "timeleft") - (now(bank) - get_attribute(bank, "start"))
         }) %>%
