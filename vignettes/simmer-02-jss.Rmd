...
[^1]: Note that the code provided does not work on recent versions of Julia and SimJulia. An analogous standalone replication script for more recent versions is supplied in the supplementary materials.
